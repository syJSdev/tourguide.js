  ...
  describe("Constructor", function () {
    ...
    tourguide._steps.forEach((step) => {
      ...
      it("Step " + step.index + " Returned From Tour Constructor Should Contain Certain Default JSON Fields", () => {
        ...
        const expectedStepKeys = ["index", "first", "last", "_target", "container", "highlight", "tooltip", "arrow", "rect", "image", "title", "content", "active", "context", "visible", "selector", "actiontarget", "_timerHandler", "_scrollCancel", "_selector", "actions"];
    ...
    it("checks if the tourguide constructor has fields returned  as expected", function () {
      const tourGuideFields = ["_current", "_active", "_stepsSrc", "_ready", "_initialposition", "start", "action", "next", "previous", "go", "stop", "complete", "_steps", "_options", "_background", "_overlay", "_keyboardHandler"];
