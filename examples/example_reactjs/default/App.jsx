    ...
    <div className="App">
      <div className="container">
        <div className="py-5 text-center" tour-step="header">
          ...
          <p>
            <button className="btn btn-success btn-lg btn-block" onClick={handleClickStartTour} tour-step="start">
              Start tour
            </button>
          </p>
        </div>
        <div className="row">
          ...
          <div className="col-md-8 order-md-1">
            ...
            >
              ...
              <hr className="mb-4" />
              <button className="btn btn-primary btn-lg btn-block" type="submit" tour-step="submit">
